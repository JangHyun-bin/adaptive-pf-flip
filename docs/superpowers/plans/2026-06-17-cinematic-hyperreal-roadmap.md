...
`docs/superpowers/plans/2026-06-18-secondary-mist-texture-falloff.md`
...
The next success condition is replacing ring-only approximation with texture/material-node style radial falloff so mist edges soften more smoothly without losing S65 visual QA or the S67/S68 render-cost range.
