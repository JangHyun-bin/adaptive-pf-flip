...
- manifest: `build/shots/s87_water_impact_ripple_focus_qa/cache/manifest.json`
- sequence: `build/shots/s87_water_impact_ripple_focus_qa/converted/sequence.json`
- water_reconstruction: `build/shots/s87_water_impact_ripple_focus_qa/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s87_water_impact_ripple_focus_qa/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s87_water_impact_ripple_focus_qa/blender/frames`
- gif: `build/shots/s87_water_impact_ripple_focus_qa/shot.gif`
- contact_sheet: `build/shots/s87_water_impact_ripple_focus_qa/review/contact_sheet.png`
- review_manifest: `build/shots/s87_water_impact_ripple_focus_qa/review/review_manifest.json`
- comparison_sheet: `build/shots/s87_water_impact_ripple_focus_qa/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s87_water_impact_ripple_focus_qa/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s87_water_impact_ripple_focus_qa/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s87_water_impact_ripple_focus_qa/review/temporal_diff_manifest.json`
- focus_sheet: `build/shots/s87_water_impact_ripple_focus_qa/review/focus_sheet.png`
- focus_review_manifest: `build/shots/s87_water_impact_ripple_focus_qa/review/focus_review_manifest.json`
- review_dir: `build/shots/s87_water_impact_ripple_focus_qa/review`
...
- Focus review summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.34, 0.98, 0.9], 'bright_threshold': 220, 'nonblank_threshold': 8, 'summary': {'mean_luminance': {'min': 70.82616532359098, 'mean': 92.49467450958204, 'max': 114.91476588453051}, 'contrast': {'min': 79.0, 'mean': 157.625, 'max': 200.0}, 'bright_ratio': {'min': 0.0, 'mean': 0.0006488894367164831, 'max': 0.0016670573306067685}, 'nonblank_ratio': {'min': 1.0, 'mean': 1.0, 'max': 1.0}}}`
- Focus review gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.95, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 79.0, 'threshold': 42.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 92.49467450958204, 'threshold': 58.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 92.49467450958204, 'threshold': 130.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.0006488894367164831, 'threshold': 0.00015, 'operator': '>=', 'passed': True}]}`
...
| `validate_render_cache` | `0` | 65.73s |
| `reconstruct_water` | `0` | 41.54s |
| `convert_render_cache` | `0` | 79.75s |
| `render_blender` | `0` | 196.55s |
| `assemble_gif` | `0` | 2.91s |

## S86 to S87 Delta

- Render preset changed from `dam_break_water_impact_ripple_fade` to `dam_break_water_impact_ripple_focus_qa`.
- The runner now emits `focus_sheet` and `focus_review_manifest` artifacts when `renderer.focus_review.enabled` is true.
- Focus crop is `[0.02, 0.34, 0.98, 0.9]`, sampled across `8` keyframes.
- Focus review gate passes with min crop contrast `79.0`, mean crop luminance `92.4947`, and mean bright ratio `0.000648889`.
- Visual QA, temporal highlight QA, camera stability, and secondary framing QA all pass.
