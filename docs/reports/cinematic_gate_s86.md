...
- Status: `ok`
- Shot preset: `dam_break_water_impact_ripple_fade`
- Render preset: `dam_break_water_impact_ripple_fade`
...
- manifest: `build/shots/s86_water_impact_ripple_material_fade/cache/manifest.json`
- sequence: `build/shots/s86_water_impact_ripple_material_fade/converted/sequence.json`
- water_reconstruction: `build/shots/s86_water_impact_ripple_material_fade/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s86_water_impact_ripple_material_fade/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s86_water_impact_ripple_material_fade/blender/frames`
- gif: `build/shots/s86_water_impact_ripple_material_fade/shot.gif`
- contact_sheet: `build/shots/s86_water_impact_ripple_material_fade/review/contact_sheet.png`
- review_manifest: `build/shots/s86_water_impact_ripple_material_fade/review/review_manifest.json`
- comparison_sheet: `build/shots/s86_water_impact_ripple_material_fade/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s86_water_impact_ripple_material_fade/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s86_water_impact_ripple_material_fade/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s86_water_impact_ripple_material_fade/review/temporal_diff_manifest.json`
- review_dir: `build/shots/s86_water_impact_ripple_material_fade/review`
...
| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 55.88s |
| `validate_render_cache` | `0` | 64.85s |
| `reconstruct_water` | `0` | 41.83s |
| `convert_render_cache` | `0` | 79.34s |
| `render_blender` | `0` | 197.71s |
| `assemble_gif` | `0` | 2.95s |

## S85 to S86 Delta

- Render preset changed from `dam_break_water_impact_ripple_tuned` to `dam_break_water_impact_ripple_fade`.
- Impact ripple pass now reports `material_falloff='edge_shader'`.
...
- Review comparison is against `build/shots/s85_water_impact_ripple_tuning/review/review_manifest.json`.
