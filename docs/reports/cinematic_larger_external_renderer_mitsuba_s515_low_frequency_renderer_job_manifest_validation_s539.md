# S539 Mitsuba S515 Low Frequency Renderer Job Manifest Validation

Generated UTC: `2026-06-20T20:15:38.118978+00:00`
Validation JSON: `build/shots/s539_mitsuba_s515_low_frequency_renderer_job_manifest/renderer_job_manifest_validation.json`
Status: `passed`
Job: `build/shots/s539_mitsuba_s515_low_frequency_renderer_job_manifest/renderer_job_manifest.json`
...
| `source:acceptance_package` | `ok` | build/shots/s538_mitsuba_s515_low_frequency_renderer_acceptance_package/renderer_acceptance_package.json |
...
| `contract:shader:glsl` | `ok` | build/shots/s538_mitsuba_s515_low_frequency_renderer_acceptance_package/shaders/low_frequency_parity_post_tonemap.glsl |
| `contract:shader:hlsl` | `ok` | build/shots/s538_mitsuba_s515_low_frequency_renderer_acceptance_package/shaders/low_frequency_parity_post_tonemap.hlsl |
...
| `frame:0:accepted_reference` | `ok` | build/shots/s536_mitsuba_s515_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0000.png |
...
| `frame:1:accepted_reference` | `ok` | build/shots/s536_mitsuba_s515_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0001.png |
...
| `frame:2:accepted_reference` | `ok` | build/shots/s536_mitsuba_s515_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0002.png |
...
| `frame:3:accepted_reference` | `ok` | build/shots/s536_mitsuba_s515_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0003.png |
...
| `frame:4:accepted_reference` | `ok` | build/shots/s536_mitsuba_s515_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0004.png |
...
| `frame:5:accepted_reference` | `ok` | build/shots/s536_mitsuba_s515_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0005.png |
...
| `frame:6:accepted_reference` | `ok` | build/shots/s536_mitsuba_s515_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0006.png |
...
| `frame:7:accepted_reference` | `ok` | build/shots/s536_mitsuba_s515_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0007.png |
