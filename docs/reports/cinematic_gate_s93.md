...
- Status: `ok`
- Shot preset: `dam_break_contact_foam_ripple_integrated`
- Render preset: `dam_break_contact_foam_ripple_integrated`
...
- manifest: `build/shots/s93_contact_foam_ripple_integration/cache/manifest.json`
- sequence: `build/shots/s93_contact_foam_ripple_integration/converted/sequence.json`
- water_reconstruction: `build/shots/s93_contact_foam_ripple_integration/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s93_contact_foam_ripple_integration/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s93_contact_foam_ripple_integration/blender/frames`
- gif: `build/shots/s93_contact_foam_ripple_integration/shot.gif`
- contact_sheet: `build/shots/s93_contact_foam_ripple_integration/review/contact_sheet.png`
- review_manifest: `build/shots/s93_contact_foam_ripple_integration/review/review_manifest.json`
- comparison_sheet: `build/shots/s93_contact_foam_ripple_integration/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s93_contact_foam_ripple_integration/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s93_contact_foam_ripple_integration/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s93_contact_foam_ripple_integration/review/temporal_diff_manifest.json`
- focus_sheet: `build/shots/s93_contact_foam_ripple_integration/review/focus_sheet.png`
- focus_review_manifest: `build/shots/s93_contact_foam_ripple_integration/review/focus_review_manifest.json`
- focus_comparison_sheet: `build/shots/s93_contact_foam_ripple_integration/review/focus_comparison_sheet.png`
- focus_comparison_manifest: `build/shots/s93_contact_foam_ripple_integration/review/focus_comparison_manifest.json`
- ripple_readability_sheet: `build/shots/s93_contact_foam_ripple_integration/review/ripple_readability_sheet.png`
- ripple_readability_manifest: `build/shots/s93_contact_foam_ripple_integration/review/ripple_readability_manifest.json`
- ripple_readability_comparison_sheet: `build/shots/s93_contact_foam_ripple_integration/review/ripple_readability_comparison_sheet.png`
- ripple_readability_comparison_manifest: `build/shots/s93_contact_foam_ripple_integration/review/ripple_readability_comparison_manifest.json`
- review_dir: `build/shots/s93_contact_foam_ripple_integration/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.019422743055555556, 'mean': 0.009729787567515432, 'min': 0.003913845486111111}, 'contrast': {'max': 203.0, 'mean': 188.63888888888889, 'min': 133.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.0021332465277777777, 'mean': 0.0010790412808641976, 'min': 3.2552083333333335e-06}, 'mean_luminance': {'max': 115.51030707465277, 'mean': 98.9455604986497, 'min': 77.79456705729167}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1323024.0, 'mean': 1208988.138888889, 'min': 938600.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 133.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 98.9455604986497, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 98.9455604986497, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.009729787567515432, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
- Temporal highlight summary: `{'frame_count': 36, 'pair_count': 35, 'sample_width': 320, 'highlight_threshold': 220, 'mean_delta': {'min': 1.5616145833333333, 'mean': 3.670118551587301, 'max': 11.52501736111111}, 'peak_delta': {'min': 72, 'mean': 118.94285714285714, 'max': 152}, 'highlight_change_ratio': {'min': 0.0, 'mean': 0.0002564484126984127, 'max': 0.0008680555555555555}, 'highlight_ratio': {'min': 0.0, 'mean': 0.0001335841049382716, 'max': 0.00045138888888888887}}`
- Temporal highlight gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_pair_count', 'value': 35.0, 'threshold': 24.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_delta', 'value': 3.670118551587301, 'threshold': 0.25, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_delta', 'value': 11.52501736111111, 'threshold': 16.0, 'operator': '<=', 'passed': True}, {'metric': 'max_peak_delta', 'value': 152.0, 'threshold': 190.0, 'operator': '<=', 'passed': True}, {'metric': 'max_highlight_change_ratio', 'value': 0.0008680555555555555, 'threshold': 0.007, 'operator': '<=', 'passed': True}]}`
...
- Focus review summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.3, 0.98, 0.88], 'bright_threshold': 220, 'nonblank_threshold': 8, 'summary': {'mean_luminance': {'min': 70.95103096800337, 'mean': 92.24476577232984, 'max': 114.7245102317535}, 'contrast': {'min': 78.0, 'mean': 152.625, 'max': 202.0}, 'bright_ratio': {'min': 0.0, 'mean': 0.00037331678693327934, 'max': 0.001011096737995418}, 'nonblank_ratio': {'min': 1.0, 'mean': 1.0, 'max': 1.0}}}`
- Focus review gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.95, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 78.0, 'threshold': 42.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 92.24476577232984, 'threshold': 58.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 92.24476577232984, 'threshold': 132.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.00037331678693327934, 'threshold': 0.00018, 'operator': '>=', 'passed': True}]}`
- Ripple readability summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.3, 0.98, 0.88], 'edge_amplify': 3.5, 'edge_threshold': 18, 'highlight_threshold': 220, 'summary': {'edge_mean': {'min': 19.212953727225973, 'mean': 35.26142597758833, 'max': 47.77894970621698}, 'edge_nonzero_ratio': {'min': 0.26235330330564344, 'mean': 0.3713350178451756, 'max': 0.4460144475788227}, 'highlight_ratio': {'min': 0.0, 'mean': 0.00037331678693327934, 'max': 0.001011096737995418}, 'mean_luminance': {'min': 70.95103096800337, 'mean': 92.24476577232984, 'max': 114.7245102317535}}}`
- Ripple readability gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_edge_mean', 'value': 35.26142597758833, 'threshold': 7.5, 'operator': '>=', 'passed': True}, {'metric': 'min_edge_nonzero_ratio', 'value': 0.3713350178451756, 'threshold': 0.02, 'operator': '>=', 'passed': True}, {'metric': 'max_highlight_ratio', 'value': 0.001011096737995418, 'threshold': 0.01, 'operator': '<=', 'passed': True}]}`
...
| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 55.40s |
| `validate_render_cache` | `0` | 64.95s |
| `reconstruct_water` | `0` | 41.64s |
| `convert_render_cache` | `0` | 79.14s |
| `render_blender` | `0` | 195.66s |
| `assemble_gif` | `0` | 2.89s |

## S92 to S93 Delta

- Render preset changed from `dam_break_ripple_readability_diagnostics` to `dam_break_contact_foam_ripple_integrated`.
- Surface contact foam now uses radius `1.32 x 0.2`, alpha scale `0.34`, and emission scale `0.42`.
- Impact ripple alpha/emission were kept close to S90 values at `0.44` and `0.82`.
- Ripple readability comparison source count is `2`, comparing S92 against S93.
