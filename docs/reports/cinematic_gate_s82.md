...
- Status: `ok`
- Shot preset: `dam_break_water_highlight_temporal_diff_sheet`
- Render preset: `dam_break_water_highlight_temporal_diff_sheet`
...
- manifest: `build/shots/s82_water_highlight_temporal_diff_sheet/cache/manifest.json`
- sequence: `build/shots/s82_water_highlight_temporal_diff_sheet/converted/sequence.json`
- water_reconstruction: `build/shots/s82_water_highlight_temporal_diff_sheet/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s82_water_highlight_temporal_diff_sheet/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s82_water_highlight_temporal_diff_sheet/blender/frames`
- gif: `build/shots/s82_water_highlight_temporal_diff_sheet/shot.gif`
- contact_sheet: `build/shots/s82_water_highlight_temporal_diff_sheet/review/contact_sheet.png`
- review_manifest: `build/shots/s82_water_highlight_temporal_diff_sheet/review/review_manifest.json`
- comparison_sheet: `build/shots/s82_water_highlight_temporal_diff_sheet/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s82_water_highlight_temporal_diff_sheet/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s82_water_highlight_temporal_diff_sheet/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s82_water_highlight_temporal_diff_sheet/review/temporal_diff_manifest.json`
- review_dir: `build/shots/s82_water_highlight_temporal_diff_sheet/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.02352322048611111, 'mean': 0.011307297694830248, 'min': 0.005068359375}, 'contrast': {'max': 203.0, 'mean': 198.86111111111111, 'min': 189.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.004420572916666666, 'mean': 0.0017126314139660492, 'min': 0.00010633680555555555}, 'mean_luminance': {'max': 115.74427083333333, 'mean': 100.20515947506752, 'min': 80.35651258680555}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1323830.0, 'mean': 1217211.111111111, 'min': 960465.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 189.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 100.20515947506752, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 100.20515947506752, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.011307297694830248, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
- Temporal highlight summary: `{'frame_count': 36, 'pair_count': 35, 'sample_width': 320, 'highlight_threshold': 220, 'mean_delta': {'min': 1.5841666666666667, 'mean': 3.6413978174603177, 'max': 11.008888888888889}, 'peak_delta': {'min': 80, 'mean': 123.08571428571429, 'max': 159}, 'highlight_change_ratio': {'min': 0.0, 'mean': 0.0006140873015873016, 'max': 0.0022743055555555555}, 'highlight_ratio': {'min': 1.736111111111111e-05, 'mean': 0.00043692129629629625, 'max': 0.0020486111111111113}}`
- Temporal highlight gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_pair_count', 'value': 35.0, 'threshold': 24.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_delta', 'value': 3.6413978174603177, 'threshold': 0.25, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_delta', 'value': 11.008888888888889, 'threshold': 14.0, 'operator': '<=', 'passed': True}, {'metric': 'max_peak_delta', 'value': 159.0, 'threshold': 190.0, 'operator': '<=', 'passed': True}, {'metric': 'max_highlight_change_ratio', 'value': 0.0022743055555555555, 'threshold': 0.006, 'operator': '<=', 'passed': True}]}`
...
- Water reflection pass: `{'alpha_scale': 0.34, 'count': 24, 'drift_per_frame': 0.035, 'emission_scale': 0.72, 'enabled': True, 'flow_dir': [1.0, 0.0, 0.14], 'length': 5.2, 'region_max': [27.2, 8.2, 18.9], 'region_min': [1.0, 5.0, 3.4], 'width': 0.12}`
...
| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 58.56s |
| `validate_render_cache` | `0` | 108.62s |
| `reconstruct_water` | `0` | 70.33s |
| `convert_render_cache` | `0` | 81.44s |
| `render_blender` | `0` | 184.38s |
| `assemble_gif` | `0` | 3.01s |

## S81 to S82 Delta

- Adds preset-driven `temporal_diff_review` artifacts to `dam_break_water_highlight_temporal_diff_sheet`.
- Emits `temporal_diff_sheet.png` and `temporal_diff_manifest.json` under the review directory.
- Selects `8` adjacent frame pairs and saves amplified grayscale differences for visual shimmer review.
- Preserves the S81 temporal highlight QA gate, Visual QA, camera stability, and active-secondary framing gates.
