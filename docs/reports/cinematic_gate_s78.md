...
- Status: `ok`
- Shot preset: `dam_break_contact_foam_fade`
- Render preset: `dam_break_contact_foam_fade`
...
- manifest: `build/shots/s78_contact_foam_material_fade/cache/manifest.json`
- sequence: `build/shots/s78_contact_foam_material_fade/converted/sequence.json`
- water_reconstruction: `build/shots/s78_contact_foam_material_fade/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s78_contact_foam_material_fade/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s78_contact_foam_material_fade/blender/frames`
- gif: `build/shots/s78_contact_foam_material_fade/shot.gif`
- contact_sheet: `build/shots/s78_contact_foam_material_fade/review/contact_sheet.png`
- review_manifest: `build/shots/s78_contact_foam_material_fade/review/review_manifest.json`
- comparison_sheet: `build/shots/s78_contact_foam_material_fade/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s78_contact_foam_material_fade/review/comparison_manifest.json`
- review_dir: `build/shots/s78_contact_foam_material_fade/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.023322482638888888, 'mean': 0.01128372757523148, 'min': 0.0050651041666666665}, 'contrast': {'max': 203.0, 'mean': 198.88888888888889, 'min': 189.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.004420572916666666, 'mean': 0.0017127519772376543, 'min': 0.00010633680555555555}, 'mean_luminance': {'max': 115.60780490451388, 'mean': 99.95803864655672, 'min': 80.01399739583333}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1320917.0, 'mean': 1209936.611111111, 'min': 945553.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 189.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 99.95803864655672, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 99.95803864655672, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.01128372757523148, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
...
- S77 made contact foam flow-aligned, but the strokes still read as separate bright marks on top of the water surface.
- S78 adds UV coordinates to surface contact foam meshes and enables `material_falloff=radial_shader` through `dam_break_contact_foam_fade`.
- The final gate renders `54-58` flow-aligned foam strokes per frame with radial material fade, alpha scale `0.42`, and emission scale `0.52`.
- Visual QA passed with mean bright ratio `0.01128372757523148`; active secondary framing QA also passed.
- The next step should add directional glint/flow cues to the water surface itself so the shot is not carried only by secondary particles and foam strokes.

## Stage Timings

| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 57.02s |
| `validate_render_cache` | `0` | 66.55s |
| `reconstruct_water` | `0` | 43.33s |
| `convert_render_cache` | `0` | 80.61s |
| `render_blender` | `0` | 176.05s |
