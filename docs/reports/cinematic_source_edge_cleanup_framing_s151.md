...
- Status: `ok`
- Shot preset: `dam_break_source_edge_cleanup_framing`
- Render preset: `dam_break_source_edge_cleanup_framing`
...
- manifest: `build/shots/s151_source_edge_cleanup_framing/cache/manifest.json`
- export_stamp: `build/shots/s151_source_edge_cleanup_framing/cache/export_stamp.json`
- validation_stamp: `build/shots/s151_source_edge_cleanup_framing/cache/validation_stamp.json`
- sequence: `build/shots/s151_source_edge_cleanup_framing/converted/sequence.json`
- water_reconstruction: `build/shots/s151_source_edge_cleanup_framing/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s151_source_edge_cleanup_framing/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s151_source_edge_cleanup_framing/blender/frames`
- gif: `build/shots/s151_source_edge_cleanup_framing/shot.gif`
- gif_stamp: `build/shots/s151_source_edge_cleanup_framing/gif_stamp.json`
- contact_sheet: `build/shots/s151_source_edge_cleanup_framing/review/contact_sheet.png`
- review_manifest: `build/shots/s151_source_edge_cleanup_framing/review/review_manifest.json`
- comparison_sheet: `build/shots/s151_source_edge_cleanup_framing/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s151_source_edge_cleanup_framing/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s151_source_edge_cleanup_framing/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s151_source_edge_cleanup_framing/review/temporal_diff_manifest.json`
- focus_sheet: `build/shots/s151_source_edge_cleanup_framing/review/focus_sheet.png`
- focus_review_manifest: `build/shots/s151_source_edge_cleanup_framing/review/focus_review_manifest.json`
- focus_comparison_sheet: `build/shots/s151_source_edge_cleanup_framing/review/focus_comparison_sheet.png`
- focus_comparison_manifest: `build/shots/s151_source_edge_cleanup_framing/review/focus_comparison_manifest.json`
- secondary_depth_sheet: `build/shots/s151_source_edge_cleanup_framing/review/secondary_depth_sheet.png`
- secondary_depth_manifest: `build/shots/s151_source_edge_cleanup_framing/review/secondary_depth_manifest.json`
- secondary_depth_comparison_sheet: `build/shots/s151_source_edge_cleanup_framing/review/secondary_depth_comparison_sheet.png`
- secondary_depth_comparison_manifest: `build/shots/s151_source_edge_cleanup_framing/review/secondary_depth_comparison_manifest.json`
- ripple_readability_sheet: `build/shots/s151_source_edge_cleanup_framing/review/ripple_readability_sheet.png`
- ripple_readability_manifest: `build/shots/s151_source_edge_cleanup_framing/review/ripple_readability_manifest.json`
- ripple_readability_comparison_sheet: `build/shots/s151_source_edge_cleanup_framing/review/ripple_readability_comparison_sheet.png`
- ripple_readability_comparison_manifest: `build/shots/s151_source_edge_cleanup_framing/review/ripple_readability_comparison_manifest.json`
- review_dir: `build/shots/s151_source_edge_cleanup_framing/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.0038444010416666665, 'mean': 0.0018243332851080245, 'min': 0.00010525173611111111}, 'contrast': {'max': 204.0, 'mean': 199.0, 'min': 185.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.0011382378472222221, 'mean': 0.00041838469328703704, 'min': 6.510416666666667e-06}, 'mean_luminance': {'max': 98.43866861979167, 'mean': 91.62542673369984, 'min': 78.82583441840278}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1239393.0, 'mean': 1183328.5, 'min': 1011390.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 185.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 91.62542673369984, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 91.62542673369984, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.0018243332851080245, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
- Temporal highlight summary: `{'frame_count': 36, 'pair_count': 35, 'sample_width': 320, 'highlight_threshold': 220, 'mean_delta': {'min': 1.1363541666666668, 'mean': 4.130090773809524, 'max': 8.49234375}, 'peak_delta': {'min': 53, 'mean': 113.6, 'max': 160}, 'highlight_change_ratio': {'min': 0.0, 'mean': 0.00018849206349206348, 'max': 0.0005729166666666667}, 'highlight_ratio': {'min': 0.0, 'mean': 0.00010416666666666667, 'max': 0.00034722222222222224}}`
- Temporal highlight gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_pair_count', 'value': 35.0, 'threshold': 24.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_delta', 'value': 4.130090773809524, 'threshold': 0.25, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_delta', 'value': 8.49234375, 'threshold': 16.0, 'operator': '<=', 'passed': True}, {'metric': 'max_peak_delta', 'value': 160.0, 'threshold': 190.0, 'operator': '<=', 'passed': True}, {'metric': 'max_highlight_change_ratio', 'value': 0.0005729166666666667, 'threshold': 0.007, 'operator': '<=', 'passed': True}]}`
...
- Focus review summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.24, 0.98, 0.98], 'bright_threshold': 220, 'nonblank_threshold': 8, 'summary': {'mean_luminance': {'min': 79.61945933227811, 'mean': 88.42866285269906, 'max': 95.34554118718336}, 'contrast': {'min': 84.0, 'mean': 174.875, 'max': 201.0}, 'bright_ratio': {'min': 0.0, 'mean': 0.00023318472661048334, 'max': 0.0006646051176121884}, 'nonblank_ratio': {'min': 1.0, 'mean': 1.0, 'max': 1.0}}}`
- Focus review gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.95, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 84.0, 'threshold': 54.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 88.42866285269906, 'threshold': 62.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 88.42866285269906, 'threshold': 132.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.00023318472661048334, 'threshold': 0.0, 'operator': '>=', 'passed': True}]}`
...
- Ripple readability summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.24, 0.98, 0.98], 'edge_amplify': 3.5, 'edge_threshold': 18, 'highlight_threshold': 220, 'summary': {'edge_mean': {'min': 19.725389748886215, 'mean': 27.46513668711919, 'max': 31.621769407997263}, 'edge_nonzero_ratio': {'min': 0.24933539488238782, 'mean': 0.3360503205382843, 'max': 0.37974008592503866}, 'highlight_ratio': {'min': 0.0, 'mean': 0.00023318472661048334, 'max': 0.0006646051176121884}, 'mean_luminance': {'min': 79.61945933227811, 'mean': 88.42866285269906, 'max': 95.34554118718336}}}`
- Ripple readability gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_edge_mean', 'value': 27.46513668711919, 'threshold': 9.0, 'operator': '>=', 'passed': True}, {'metric': 'min_edge_nonzero_ratio', 'value': 0.3360503205382843, 'threshold': 0.03, 'operator': '>=', 'passed': True}, {'metric': 'max_highlight_ratio', 'value': 0.0006646051176121884, 'threshold': 0.011, 'operator': '<=', 'passed': True}]}`
...
| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 122.40s |
| `validate_render_cache` | `0` | 190.96s |
| `reconstruct_water` | `0` | 120.42s |
| `convert_render_cache` | `0` | 215.25s |
| `render_blender` | `0` | 299.56s |
...
- The source-edge cleanup is a framing/timing pass, not a new simulation event; some upper source fragments remain visible because the current camera still keeps the contact spray band and secondaries in frame.
- The water thickness/refraction look remains renderer-side layered scattering and material tuning rather than a physical volumetric ray tracer.
...
Package and publish the S151 shot artifacts, then review the public gallery to decide whether to keep tightening composition or move to a stronger physically coupled spray/foam pass.
