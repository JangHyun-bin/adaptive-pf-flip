...
- Status: `ok`
- Shot preset: `dam_break_contact_focus_camera_tuned`
- Render preset: `dam_break_contact_focus_camera_tuned`
...
- manifest: `build/shots/s89_contact_focus_camera_tuning/cache/manifest.json`
- sequence: `build/shots/s89_contact_focus_camera_tuning/converted/sequence.json`
- water_reconstruction: `build/shots/s89_contact_focus_camera_tuning/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s89_contact_focus_camera_tuning/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s89_contact_focus_camera_tuning/blender/frames`
- gif: `build/shots/s89_contact_focus_camera_tuning/shot.gif`
- contact_sheet: `build/shots/s89_contact_focus_camera_tuning/review/contact_sheet.png`
- review_manifest: `build/shots/s89_contact_focus_camera_tuning/review/review_manifest.json`
- comparison_sheet: `build/shots/s89_contact_focus_camera_tuning/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s89_contact_focus_camera_tuning/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s89_contact_focus_camera_tuning/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s89_contact_focus_camera_tuning/review/temporal_diff_manifest.json`
- focus_sheet: `build/shots/s89_contact_focus_camera_tuning/review/focus_sheet.png`
- focus_review_manifest: `build/shots/s89_contact_focus_camera_tuning/review/focus_review_manifest.json`
- focus_comparison_sheet: `build/shots/s89_contact_focus_camera_tuning/review/focus_comparison_sheet.png`
- focus_comparison_manifest: `build/shots/s89_contact_focus_camera_tuning/review/focus_comparison_manifest.json`
- review_dir: `build/shots/s89_contact_focus_camera_tuning/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.01931640625, 'mean': 0.009702238859953704, 'min': 0.003913845486111111}, 'contrast': {'max': 203.0, 'mean': 188.61111111111111, 'min': 133.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.0021332465277777777, 'mean': 0.00107886043595679, 'min': 3.2552083333333335e-06}, 'mean_luminance': {'max': 115.5060134548611, 'mean': 98.93310986930942, 'min': 77.78816514756944}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1322696.0, 'mean': 1208766.388888889, 'min': 937889.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 133.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 98.93310986930942, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 98.93310986930942, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.009702238859953704, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
- Temporal highlight summary: `{'frame_count': 36, 'pair_count': 35, 'sample_width': 320, 'highlight_threshold': 220, 'mean_delta': {'min': 1.5528125, 'mean': 3.658162698412698, 'max': 11.52125}, 'peak_delta': {'min': 72, 'mean': 119.0, 'max': 152}, 'highlight_change_ratio': {'min': 0.0, 'mean': 0.0002564484126984127, 'max': 0.0008680555555555555}, 'highlight_ratio': {'min': 0.0, 'mean': 0.0001335841049382716, 'max': 0.00045138888888888887}}`
- Temporal highlight gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_pair_count', 'value': 35.0, 'threshold': 24.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_delta', 'value': 3.658162698412698, 'threshold': 0.25, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_delta', 'value': 11.52125, 'threshold': 16.0, 'operator': '<=', 'passed': True}, {'metric': 'max_peak_delta', 'value': 152.0, 'threshold': 190.0, 'operator': '<=', 'passed': True}, {'metric': 'max_highlight_change_ratio', 'value': 0.0008680555555555555, 'threshold': 0.007, 'operator': '<=', 'passed': True}]}`
...
- Focus review summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.3, 0.98, 0.88], 'bright_threshold': 220, 'nonblank_threshold': 8, 'summary': {'mean_luminance': {'min': 70.95150047535184, 'mean': 92.2294904676371, 'max': 114.71677407540172}, 'contrast': {'min': 78.0, 'mean': 152.625, 'max': 202.0}, 'bright_ratio': {'min': 0.0, 'mean': 0.00037331678693327934, 'max': 0.001011096737995418}, 'nonblank_ratio': {'min': 1.0, 'mean': 1.0, 'max': 1.0}}}`
- Focus review gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.95, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 78.0, 'threshold': 42.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 92.2294904676371, 'threshold': 58.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 92.2294904676371, 'threshold': 132.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.00037331678693327934, 'threshold': 0.00015, 'operator': '>=', 'passed': True}]}`
...
| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 73.82s |
| `validate_render_cache` | `0` | 64.71s |
| `reconstruct_water` | `0` | 41.96s |
| `convert_render_cache` | `0` | 106.63s |
| `render_blender` | `0` | 233.25s |
| `assemble_gif` | `0` | 2.89s |

## S88 to S89 Delta

- Render preset changed from `dam_break_water_impact_ripple_focus_qa` to `dam_break_contact_focus_camera_tuned`.
- Camera FOV range narrowed from `40-44` degrees to `38-42` degrees.
- Focus crop changed from `[0.02, 0.34, 0.98, 0.9]` to `[0.02, 0.3, 0.98, 0.88]`.
- Focus comparison source count is `2`, comparing S88 against S89.
- Camera stability, secondary framing, focus review, visual QA, and temporal highlight QA all pass.
