...
- Status: `ok`
- Shot preset: `dam_break_water_impact_ripple_tuned`
- Render preset: `dam_break_water_impact_ripple_tuned`
...
- manifest: `build/shots/s85_water_impact_ripple_tuning/cache/manifest.json`
- sequence: `build/shots/s85_water_impact_ripple_tuning/converted/sequence.json`
- water_reconstruction: `build/shots/s85_water_impact_ripple_tuning/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s85_water_impact_ripple_tuning/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s85_water_impact_ripple_tuning/blender/frames`
- gif: `build/shots/s85_water_impact_ripple_tuning/shot.gif`
- contact_sheet: `build/shots/s85_water_impact_ripple_tuning/review/contact_sheet.png`
- review_manifest: `build/shots/s85_water_impact_ripple_tuning/review/review_manifest.json`
- comparison_sheet: `build/shots/s85_water_impact_ripple_tuning/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s85_water_impact_ripple_tuning/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s85_water_impact_ripple_tuning/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s85_water_impact_ripple_tuning/review/temporal_diff_manifest.json`
- review_dir: `build/shots/s85_water_impact_ripple_tuning/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.023362630208333332, 'mean': 0.011288730951003086, 'min': 0.005069444444444444}, 'contrast': {'max': 203.0, 'mean': 198.88888888888889, 'min': 189.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.004418402777777778, 'mean': 0.0017118477527006172, 'min': 0.00010633680555555555}, 'mean_luminance': {'max': 115.754208984375, 'mean': 100.23090470679011, 'min': 80.36129231770833}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1325242.0, 'mean': 1219486.9444444445, 'min': 962661.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 189.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 100.23090470679011, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 100.23090470679011, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.011288730951003086, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
- Temporal highlight summary: `{'frame_count': 36, 'pair_count': 35, 'sample_width': 320, 'highlight_threshold': 220, 'mean_delta': {'min': 1.62375, 'mean': 3.6696250000000004, 'max': 11.017256944444444}, 'peak_delta': {'min': 80, 'mean': 123.08571428571429, 'max': 159}, 'highlight_change_ratio': {'min': 0.0, 'mean': 0.0006140873015873016, 'max': 0.0022743055555555555}, 'highlight_ratio': {'min': 1.736111111111111e-05, 'mean': 0.00043692129629629625, 'max': 0.0020486111111111113}}`
- Temporal highlight gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_pair_count', 'value': 35.0, 'threshold': 24.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_delta', 'value': 3.6696250000000004, 'threshold': 0.25, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_delta', 'value': 11.017256944444444, 'threshold': 16.0, 'operator': '<=', 'passed': True}, {'metric': 'max_peak_delta', 'value': 159.0, 'threshold': 190.0, 'operator': '<=', 'passed': True}, {'metric': 'max_highlight_change_ratio', 'value': 0.0022743055555555555, 'threshold': 0.007, 'operator': '<=', 'passed': True}]}`
...
- Water impact ripple pass: `{'alpha_scale': 0.36, 'arc_fraction': 0.52, 'channels': {'foam': 1.0, 'spray': 0.18}, 'emission_scale': 0.62, 'enabled': True, 'flow_center': [14.0, 0.0, 11.0], 'max_count': 72, 'radius': 0.44, 'radius_step': 0.26, 'ring_count': 2, 'segments': 18, 'vertical_offset': -1.82, 'width': 0.045}`
...
| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 55.79s |
| `validate_render_cache` | `0` | 65.60s |
| `reconstruct_water` | `0` | 41.95s |
| `convert_render_cache` | `0` | 120.61s |
| `render_blender` | `0` | 253.37s |
| `assemble_gif` | `0` | 4.19s |

## S84 to S85 Delta

- Adds `dam_break_water_impact_ripple_tuned`.
- Reduces impact ripple candidates from `96` to `72` per frame.
- Lowers spray ripple weighting, arc size, width, alpha, emission scale, and material emission strength.
