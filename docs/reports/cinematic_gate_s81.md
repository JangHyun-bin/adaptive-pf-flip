...
- Status: `ok`
- Shot preset: `dam_break_water_highlight_temporal_review`
- Render preset: `dam_break_water_highlight_temporal_review`
...
- manifest: `build/shots/s81_water_highlight_temporal_review/cache/manifest.json`
- sequence: `build/shots/s81_water_highlight_temporal_review/converted/sequence.json`
- water_reconstruction: `build/shots/s81_water_highlight_temporal_review/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s81_water_highlight_temporal_review/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s81_water_highlight_temporal_review/blender/frames`
- gif: `build/shots/s81_water_highlight_temporal_review/shot.gif`
- contact_sheet: `build/shots/s81_water_highlight_temporal_review/review/contact_sheet.png`
- review_manifest: `build/shots/s81_water_highlight_temporal_review/review/review_manifest.json`
- comparison_sheet: `build/shots/s81_water_highlight_temporal_review/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s81_water_highlight_temporal_review/review/comparison_manifest.json`
- review_dir: `build/shots/s81_water_highlight_temporal_review/review`
...
| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 55.39s |
| `validate_render_cache` | `0` | 65.10s |
| `reconstruct_water` | `0` | 42.52s |
| `convert_render_cache` | `0` | 82.80s |
| `render_blender` | `0` | 179.31s |
| `assemble_gif` | `0` | 3.04s |

## S80 to S81 Delta

- Adds the preset-driven `temporal_highlight_qa` gate to `dam_break_water_highlight_temporal_review`.
- Measures `35` frame pairs for grayscale motion, peak frame delta, highlight ratio, and highlight-mask change ratio.
- Preserves Visual QA, camera stability, active-secondary framing, and S80 reflection continuity gates.
