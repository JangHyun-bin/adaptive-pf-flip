...
- Status: `ok`
- Shot preset: `dam_break_water_depth_focus_comparison`
- Render preset: `dam_break_water_depth_focus_comparison`
...
- manifest: `build/shots/s100_water_depth_focus_comparison/cache/manifest.json`
- sequence: `build/shots/s100_water_depth_focus_comparison/converted/sequence.json`
- water_reconstruction: `build/shots/s100_water_depth_focus_comparison/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s100_water_depth_focus_comparison/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s100_water_depth_focus_comparison/blender/frames`
- gif: `build/shots/s100_water_depth_focus_comparison/shot.gif`
- contact_sheet: `build/shots/s100_water_depth_focus_comparison/review/contact_sheet.png`
- review_manifest: `build/shots/s100_water_depth_focus_comparison/review/review_manifest.json`
- comparison_sheet: `build/shots/s100_water_depth_focus_comparison/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s100_water_depth_focus_comparison/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s100_water_depth_focus_comparison/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s100_water_depth_focus_comparison/review/temporal_diff_manifest.json`
- focus_sheet: `build/shots/s100_water_depth_focus_comparison/review/focus_sheet.png`
- focus_review_manifest: `build/shots/s100_water_depth_focus_comparison/review/focus_review_manifest.json`
- focus_comparison_sheet: `build/shots/s100_water_depth_focus_comparison/review/focus_comparison_sheet.png`
- focus_comparison_manifest: `build/shots/s100_water_depth_focus_comparison/review/focus_comparison_manifest.json`
- secondary_depth_sheet: `build/shots/s100_water_depth_focus_comparison/review/secondary_depth_sheet.png`
- secondary_depth_manifest: `build/shots/s100_water_depth_focus_comparison/review/secondary_depth_manifest.json`
- secondary_depth_comparison_sheet: `build/shots/s100_water_depth_focus_comparison/review/secondary_depth_comparison_sheet.png`
- secondary_depth_comparison_manifest: `build/shots/s100_water_depth_focus_comparison/review/secondary_depth_comparison_manifest.json`
- ripple_readability_sheet: `build/shots/s100_water_depth_focus_comparison/review/ripple_readability_sheet.png`
- ripple_readability_manifest: `build/shots/s100_water_depth_focus_comparison/review/ripple_readability_manifest.json`
- ripple_readability_comparison_sheet: `build/shots/s100_water_depth_focus_comparison/review/ripple_readability_comparison_sheet.png`
- ripple_readability_comparison_manifest: `build/shots/s100_water_depth_focus_comparison/review/ripple_readability_comparison_manifest.json`
- review_dir: `build/shots/s100_water_depth_focus_comparison/review`
...
- Focus review summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.42, 0.98, 0.95], 'bright_threshold': 220, 'nonblank_threshold': 8, 'summary': {'mean_luminance': {'min': 74.55578389071746, 'mean': 92.42673194825792, 'max': 116.9137532615925}, 'contrast': {'min': 75.0, 'mean': 149.125, 'max': 196.0}, 'bright_ratio': {'min': 0.0, 'mean': 0.00011964501935637907, 'max': 0.00047538243770997834}, 'nonblank_ratio': {'min': 1.0, 'mean': 1.0, 'max': 1.0}}}`
- Focus review gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.95, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 75.0, 'threshold': 60.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 92.42673194825792, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 92.42673194825792, 'threshold': 125.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.00011964501935637907, 'threshold': 0.0, 'operator': '>=', 'passed': True}]}`
...
- Ripple readability summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.3, 0.98, 0.88], 'edge_amplify': 3.5, 'edge_threshold': 18, 'highlight_threshold': 220, 'summary': {'edge_mean': {'min': 17.420298692392812, 'mean': 31.339494237333042, 'max': 42.335374359054285}, 'edge_nonzero_ratio': {'min': 0.25303329021398624, 'mean': 0.36233693873416145, 'max': 0.443540280223805}, 'highlight_ratio': {'min': 0.0, 'mean': 0.00016291515359319233, 'max': 0.0004013216339634992}, 'mean_luminance': {'min': 71.91699655564733, 'mean': 93.9335367053442, 'max': 119.48853895547278}}}`
- Ripple readability gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_edge_mean', 'value': 31.339494237333042, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_edge_nonzero_ratio', 'value': 0.36233693873416145, 'threshold': 0.025, 'operator': '>=', 'passed': True}, {'metric': 'max_highlight_ratio', 'value': 0.0004013216339634992, 'threshold': 0.01, 'operator': '<=', 'passed': True}]}`
...
| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 55.85s |
| `validate_render_cache` | `0` | 65.83s |
| `reconstruct_water` | `0` | 41.84s |
| `convert_render_cache` | `0` | 78.87s |
| `render_blender` | `0` | 198.04s |
