...
- manifest: `build/shots/s65_visual_qa_metrics/cache/manifest.json`
- sequence: `build/shots/s65_visual_qa_metrics/converted/sequence.json`
- water_reconstruction: `build/shots/s65_visual_qa_metrics/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s65_visual_qa_metrics/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s65_visual_qa_metrics/blender/frames`
- gif: `build/shots/s65_visual_qa_metrics/shot.gif`
- contact_sheet: `build/shots/s65_visual_qa_metrics/review/contact_sheet.png`
- review_manifest: `build/shots/s65_visual_qa_metrics/review/review_manifest.json`
- comparison_sheet: `build/shots/s65_visual_qa_metrics/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s65_visual_qa_metrics/review/comparison_manifest.json`
- review_dir: `build/shots/s65_visual_qa_metrics/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.01628689236111111, 'mean': 0.006416467737268518, 'min': 1.0850694444444444e-06}, 'contrast': {'max': 203.0, 'mean': 185.33333333333334, 'min': 90.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.0018424479166666667, 'mean': 0.0006449833622685186, 'min': 0.0}, 'mean_luminance': {'max': 112.83057074652778, 'mean': 95.06404724874614, 'min': 75.37037217881945}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1310922.0, 'mean': 1172781.9166666667, 'min': 856440.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 90.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 95.06404724874614, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 95.06404724874614, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.006416467737268518, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
...
- S64 added camera path stability metrics and wide/close comparison sheets.
- S65 adds render-frame visual QA from Blender outputs: nonblank ratio, contrast, mean luminance, bright/highlight ratios, dark ratio, and PNG byte ranges.
- The preset visual QA gate passed with min contrast `90`, mean luminance `95.06404724874614`, and mean bright ratio `0.006416467737268518`.
- These gates make visually empty, overly flat, or badly exposed cinematic runs fail before manual inspection.

## Stage Timings

| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 55.25s |
| `validate_render_cache` | `0` | 65.64s |
| `reconstruct_water` | `0` | 42.94s |
| `convert_render_cache` | `0` | 80.30s |
| `render_blender` | `0` | 88.52s |
