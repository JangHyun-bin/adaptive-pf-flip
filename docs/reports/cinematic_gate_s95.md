...
- Status: `ok`
- Shot preset: `dam_break_spray_foam_depth_layered`
- Render preset: `dam_break_spray_foam_depth_layered`
...
- manifest: `build/shots/s95_spray_foam_depth_layering/cache/manifest.json`
- sequence: `build/shots/s95_spray_foam_depth_layering/converted/sequence.json`
- water_reconstruction: `build/shots/s95_spray_foam_depth_layering/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s95_spray_foam_depth_layering/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s95_spray_foam_depth_layering/blender/frames`
- gif: `build/shots/s95_spray_foam_depth_layering/shot.gif`
- contact_sheet: `build/shots/s95_spray_foam_depth_layering/review/contact_sheet.png`
- review_manifest: `build/shots/s95_spray_foam_depth_layering/review/review_manifest.json`
- comparison_sheet: `build/shots/s95_spray_foam_depth_layering/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s95_spray_foam_depth_layering/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s95_spray_foam_depth_layering/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s95_spray_foam_depth_layering/review/temporal_diff_manifest.json`
- focus_sheet: `build/shots/s95_spray_foam_depth_layering/review/focus_sheet.png`
- focus_review_manifest: `build/shots/s95_spray_foam_depth_layering/review/focus_review_manifest.json`
- focus_comparison_sheet: `build/shots/s95_spray_foam_depth_layering/review/focus_comparison_sheet.png`
- focus_comparison_manifest: `build/shots/s95_spray_foam_depth_layering/review/focus_comparison_manifest.json`
- ripple_readability_sheet: `build/shots/s95_spray_foam_depth_layering/review/ripple_readability_sheet.png`
- ripple_readability_manifest: `build/shots/s95_spray_foam_depth_layering/review/ripple_readability_manifest.json`
- ripple_readability_comparison_sheet: `build/shots/s95_spray_foam_depth_layering/review/ripple_readability_comparison_sheet.png`
- ripple_readability_comparison_manifest: `build/shots/s95_spray_foam_depth_layering/review/ripple_readability_comparison_manifest.json`
- review_dir: `build/shots/s95_spray_foam_depth_layering/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.014946831597222222, 'mean': 0.007738745418595679, 'min': 0.00328125}, 'contrast': {'max': 203.0, 'mean': 186.61111111111111, 'min': 134.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.0015711805555555555, 'mean': 0.000866066261574074, 'min': 1.0850694444444444e-06}, 'mean_luminance': {'max': 115.17658094618055, 'mean': 98.67854651933834, 'min': 77.4676171875}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1323168.0, 'mean': 1210013.7222222222, 'min': 940936.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 134.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 98.67854651933834, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 98.67854651933834, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.007738745418595679, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
- Temporal highlight summary: `{'frame_count': 36, 'pair_count': 35, 'sample_width': 320, 'highlight_threshold': 220, 'mean_delta': {'min': 1.5070138888888889, 'mean': 3.53359623015873, 'max': 11.359756944444445}, 'peak_delta': {'min': 82, 'mean': 118.4, 'max': 154}, 'highlight_change_ratio': {'min': 0.0, 'mean': 0.00018898809523809523, 'max': 0.0006597222222222222}, 'highlight_ratio': {'min': 0.0, 'mean': 0.00010464891975308641, 'max': 0.0005034722222222222}}`
- Temporal highlight gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_pair_count', 'value': 35.0, 'threshold': 24.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_delta', 'value': 3.53359623015873, 'threshold': 0.25, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_delta', 'value': 11.359756944444445, 'threshold': 16.0, 'operator': '<=', 'passed': True}, {'metric': 'max_peak_delta', 'value': 154.0, 'threshold': 190.0, 'operator': '<=', 'passed': True}, {'metric': 'max_highlight_change_ratio', 'value': 0.0006597222222222222, 'threshold': 0.007, 'operator': '<=', 'passed': True}]}`
...
| `validate_render_cache` | `0` | 65.70s |
| `reconstruct_water` | `0` | 42.37s |
| `convert_render_cache` | `0` | 79.42s |
| `render_blender` | `0` | 201.64s |
| `assemble_gif` | `0` | 2.97s |

## S94 to S95 Delta

- Render preset changed from `dam_break_water_surface_breakup_noise_tuned` to `dam_break_spray_foam_depth_layered`.
- Secondary radius scales changed from spray `1.35`, foam `1.85` to spray `1.18`, foam `1.65`.
- Secondary soft pass changed from spray `2.35`, foam `2.0`, alpha `0.22`, emission `0.88`, max radius `0.98` to spray `2.0`, foam `1.65`, alpha `0.18`, emission `0.72`, max radius `0.86`.
- Secondary streak pass changed from spray `1.0`, foam `0.35`, alpha `0.21`, emission `1.08`, max length `1.35`, width scale `0.5` to spray `0.92`, foam `0.24`, alpha `0.18`, emission `0.94`, max length `1.15`, width scale `0.42`.
- Surface contact foam changed from radius_x `1.32`, radius_z `0.2`, vertical offset `-1.85`, alpha `0.34`, emission `0.42` to radius_x `1.42`, radius_z `0.17`, vertical offset `-1.92`, alpha `0.3`, emission `0.36`.
- Visual QA, temporal highlight QA, camera stability, secondary framing QA, focus review QA, and ripple readability QA all pass.
