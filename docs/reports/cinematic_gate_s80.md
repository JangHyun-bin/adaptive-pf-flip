...
- Status: `ok`
- Shot preset: `dam_break_water_reflection_continuity`
- Render preset: `dam_break_water_reflection_continuity`
...
- manifest: `build/shots/s80_water_reflection_continuity/cache/manifest.json`
- sequence: `build/shots/s80_water_reflection_continuity/converted/sequence.json`
- water_reconstruction: `build/shots/s80_water_reflection_continuity/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s80_water_reflection_continuity/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s80_water_reflection_continuity/blender/frames`
- gif: `build/shots/s80_water_reflection_continuity/shot.gif`
- contact_sheet: `build/shots/s80_water_reflection_continuity/review/contact_sheet.png`
- review_manifest: `build/shots/s80_water_reflection_continuity/review/review_manifest.json`
- comparison_sheet: `build/shots/s80_water_reflection_continuity/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s80_water_reflection_continuity/review/comparison_manifest.json`
- review_dir: `build/shots/s80_water_reflection_continuity/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.02352322048611111, 'mean': 0.011307267554012346, 'min': 0.005068359375}, 'contrast': {'max': 203.0, 'mean': 198.86111111111111, 'min': 189.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.004420572916666666, 'mean': 0.0017126314139660492, 'min': 0.00010633680555555555}, 'mean_luminance': {'max': 115.74427083333333, 'mean': 100.20515796802663, 'min': 80.35650499131944}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1323835.0, 'mean': 1217212.1666666667, 'min': 960463.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 189.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 100.20515796802663, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 100.20515796802663, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.011307267554012346, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
...
| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 58.10s |
| `validate_render_cache` | `0` | 66.12s |
| `reconstruct_water` | `0` | 42.89s |
| `convert_render_cache` | `0` | 79.84s |
| `render_blender` | `0` | 168.68s |
| `assemble_gif` | `0` | 2.97s |

## S79 to S80 Delta

- Adds the preset-driven `water_reflection_pass` to `dam_break_water_reflection_continuity`.
- Keeps S79 glints and S78 contact foam fade active while adding `24` longer water reflection ribbons per frame.
