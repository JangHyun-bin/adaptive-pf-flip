# S498 Mitsuba Low Frequency Renderer Acceptance Package Validation

Generated UTC: `2026-06-20T18:40:41.583327+00:00`
Validation JSON: `build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/renderer_acceptance_package_validation.json`
Status: `passed`
Package: `build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/renderer_acceptance_package.json`
...
| `source:runtime_summary` | `ok` | build/shots/s497_mitsuba_low_frequency_renderer_runtime_preview/renderer_runtime_preview_summary.json |
| `source:runtime_summary:schema` | `ok` | source schema |
| `source:runtime_summary:status` | `ok` | source status |
| `source:runtime_validation` | `ok` | build/shots/s497_mitsuba_low_frequency_renderer_runtime_preview/renderer_runtime_preview_validation.json |
...
| `source:runtime_handoff_bundle` | `ok` | build/shots/s494_mitsuba_low_frequency_runtime_handoff_bundle/runtime_handoff_bundle.json |
| `source:runtime_handoff_bundle:schema` | `ok` | source schema |
| `source:runtime_handoff_bundle:status` | `ok` | source status |
| `source:publish_manifest` | `ok` | build/shots/s496_mitsuba_low_frequency_runtime_publish_gallery/publish_manifest.json |
...
| `copied:metadata:renderer_runtime_preview_summary` | `ok` | build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/metadata/renderer_runtime_preview_summary.json |
| `copied:metadata:renderer_runtime_preview_validation` | `ok` | build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/metadata/renderer_runtime_preview_validation.json |
| `copied:metadata:runtime_import_preview` | `ok` | build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/metadata/runtime_import_preview.json |
| `copied:metadata:runtime_handoff_bundle` | `ok` | build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/metadata/runtime_handoff_bundle.json |
| `copied:metadata:publish_manifest` | `ok` | build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/metadata/publish_manifest.json |
| `copied:glsl_shader:low_frequency_parity_post_tonemap.glsl` | `ok` | build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/shaders/low_frequency_parity_post_tonemap.glsl |
| `copied:hlsl_shader:low_frequency_parity_post_tonemap.hlsl` | `ok` | build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/shaders/low_frequency_parity_post_tonemap.hlsl |
| `copied:runtime_gif:Renderer Runtime GIF` | `ok` | build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/gallery/shot.gif |
| `copied:strip_gif:Runtime Strip GIF` | `ok` | build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/gallery/runtime_consumer_strips.gif |
