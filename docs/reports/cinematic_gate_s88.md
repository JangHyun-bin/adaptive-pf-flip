...
- Status: `ok`
- Shot preset: `dam_break_water_impact_ripple_focus_qa`
- Render preset: `dam_break_water_impact_ripple_focus_qa`
...
- manifest: `build/shots/s88_water_impact_ripple_focus_comparison/cache/manifest.json`
- sequence: `build/shots/s88_water_impact_ripple_focus_comparison/converted/sequence.json`
- water_reconstruction: `build/shots/s88_water_impact_ripple_focus_comparison/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s88_water_impact_ripple_focus_comparison/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s88_water_impact_ripple_focus_comparison/blender/frames`
- gif: `build/shots/s88_water_impact_ripple_focus_comparison/shot.gif`
- contact_sheet: `build/shots/s88_water_impact_ripple_focus_comparison/review/contact_sheet.png`
- review_manifest: `build/shots/s88_water_impact_ripple_focus_comparison/review/review_manifest.json`
- comparison_sheet: `build/shots/s88_water_impact_ripple_focus_comparison/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s88_water_impact_ripple_focus_comparison/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s88_water_impact_ripple_focus_comparison/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s88_water_impact_ripple_focus_comparison/review/temporal_diff_manifest.json`
- focus_sheet: `build/shots/s88_water_impact_ripple_focus_comparison/review/focus_sheet.png`
- focus_review_manifest: `build/shots/s88_water_impact_ripple_focus_comparison/review/focus_review_manifest.json`
- focus_comparison_sheet: `build/shots/s88_water_impact_ripple_focus_comparison/review/focus_comparison_sheet.png`
- focus_comparison_manifest: `build/shots/s88_water_impact_ripple_focus_comparison/review/focus_comparison_manifest.json`
- review_dir: `build/shots/s88_water_impact_ripple_focus_comparison/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.023349609375, 'mean': 0.011288610387731482, 'min': 0.005069444444444444}, 'contrast': {'max': 203.0, 'mean': 198.88888888888889, 'min': 189.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.004419487847222223, 'mean': 0.0017122998649691358, 'min': 0.00010633680555555555}, 'mean_luminance': {'max': 115.75190755208334, 'mean': 100.22410038700811, 'min': 80.36132378472222}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1325014.0, 'mean': 1219240.5833333333, 'min': 962543.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 189.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 100.22410038700811, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 100.22410038700811, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.011288610387731482, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
- Temporal highlight summary: `{'frame_count': 36, 'pair_count': 35, 'sample_width': 320, 'highlight_threshold': 220, 'mean_delta': {'min': 1.619982638888889, 'mean': 3.660333333333334, 'max': 11.020104166666666}, 'peak_delta': {'min': 80, 'mean': 123.08571428571429, 'max': 159}, 'highlight_change_ratio': {'min': 0.0, 'mean': 0.0006140873015873016, 'max': 0.0022743055555555555}, 'highlight_ratio': {'min': 1.736111111111111e-05, 'mean': 0.00043692129629629625, 'max': 0.0020486111111111113}}`
- Temporal highlight gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_pair_count', 'value': 35.0, 'threshold': 24.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_delta', 'value': 3.660333333333334, 'threshold': 0.25, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_delta', 'value': 11.020104166666666, 'threshold': 16.0, 'operator': '<=', 'passed': True}, {'metric': 'max_peak_delta', 'value': 159.0, 'threshold': 190.0, 'operator': '<=', 'passed': True}, {'metric': 'max_highlight_change_ratio', 'value': 0.0022743055555555555, 'threshold': 0.007, 'operator': '<=', 'passed': True}]}`
...
- Water impact ripple pass: `{'alpha_scale': 0.42, 'arc_fraction': 0.52, 'channels': {'foam': 1.0, 'spray': 0.18}, 'emission_scale': 0.72, 'enabled': True, 'flow_center': [14.0, 0.0, 11.0], 'material_falloff': 'edge_shader', 'max_count': 72, 'radius': 0.44, 'radius_step': 0.26, 'ring_count': 2, 'segments': 18, 'vertical_offset': -1.82, 'width': 0.045}`
...
- Focus review summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.34, 0.98, 0.9], 'bright_threshold': 220, 'nonblank_threshold': 8, 'summary': {'mean_luminance': {'min': 70.82616532359098, 'mean': 92.49467349924427, 'max': 114.91476386385496}, 'contrast': {'min': 79.0, 'mean': 157.625, 'max': 200.0}, 'bright_ratio': {'min': 0.0, 'mean': 0.0006488894367164831, 'max': 0.0016670573306067685}, 'nonblank_ratio': {'min': 1.0, 'mean': 1.0, 'max': 1.0}}}`
- Focus review gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.95, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 79.0, 'threshold': 42.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 92.49467349924427, 'threshold': 58.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 92.49467349924427, 'threshold': 130.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.0006488894367164831, 'threshold': 0.00015, 'operator': '>=', 'passed': True}]}`
...
| `validate_render_cache` | `0` | 65.38s |
| `reconstruct_water` | `0` | 42.30s |
| `convert_render_cache` | `0` | 79.39s |
| `render_blender` | `0` | 197.54s |
| `assemble_gif` | `0` | 2.94s |

## S87 to S88 Delta

- The runner now emits `focus_comparison_sheet` and `focus_comparison_manifest` when compared review manifests include `focus_sheet`.
- Focus comparison source count is `2`, comparing S87 against S88.
- The S88 focus comparison manifest uses schema `lsfs_cinematic_focus_review_comparison`.
- Focus review gate, visual QA, temporal highlight QA, camera stability, and secondary framing QA all pass.
