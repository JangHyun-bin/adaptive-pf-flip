...
- manifest: `build/shots/s98_secondary_depth_comparison_sheet/cache/manifest.json`
- sequence: `build/shots/s98_secondary_depth_comparison_sheet/converted/sequence.json`
- water_reconstruction: `build/shots/s98_secondary_depth_comparison_sheet/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s98_secondary_depth_comparison_sheet/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s98_secondary_depth_comparison_sheet/blender/frames`
- gif: `build/shots/s98_secondary_depth_comparison_sheet/shot.gif`
- contact_sheet: `build/shots/s98_secondary_depth_comparison_sheet/review/contact_sheet.png`
- review_manifest: `build/shots/s98_secondary_depth_comparison_sheet/review/review_manifest.json`
- comparison_sheet: `build/shots/s98_secondary_depth_comparison_sheet/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s98_secondary_depth_comparison_sheet/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s98_secondary_depth_comparison_sheet/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s98_secondary_depth_comparison_sheet/review/temporal_diff_manifest.json`
- focus_sheet: `build/shots/s98_secondary_depth_comparison_sheet/review/focus_sheet.png`
- focus_review_manifest: `build/shots/s98_secondary_depth_comparison_sheet/review/focus_review_manifest.json`
- focus_comparison_sheet: `build/shots/s98_secondary_depth_comparison_sheet/review/focus_comparison_sheet.png`
- focus_comparison_manifest: `build/shots/s98_secondary_depth_comparison_sheet/review/focus_comparison_manifest.json`
- secondary_depth_sheet: `build/shots/s98_secondary_depth_comparison_sheet/review/secondary_depth_sheet.png`
- secondary_depth_manifest: `build/shots/s98_secondary_depth_comparison_sheet/review/secondary_depth_manifest.json`
- secondary_depth_comparison_sheet: `build/shots/s98_secondary_depth_comparison_sheet/review/secondary_depth_comparison_sheet.png`
- secondary_depth_comparison_manifest: `build/shots/s98_secondary_depth_comparison_sheet/review/secondary_depth_comparison_manifest.json`
- ripple_readability_sheet: `build/shots/s98_secondary_depth_comparison_sheet/review/ripple_readability_sheet.png`
- ripple_readability_manifest: `build/shots/s98_secondary_depth_comparison_sheet/review/ripple_readability_manifest.json`
- ripple_readability_comparison_sheet: `build/shots/s98_secondary_depth_comparison_sheet/review/ripple_readability_comparison_sheet.png`
- ripple_readability_comparison_manifest: `build/shots/s98_secondary_depth_comparison_sheet/review/ripple_readability_comparison_manifest.json`
- review_dir: `build/shots/s98_secondary_depth_comparison_sheet/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.007081163194444445, 'mean': 0.0045580451871141976, 'min': 0.0025477430555555557}, 'contrast': {'max': 203.0, 'mean': 186.33333333333334, 'min': 134.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.00142578125, 'mean': 0.0007924925250771606, 'min': 2.170138888888889e-06}, 'mean_luminance': {'max': 115.03796332465278, 'mean': 98.36693455825618, 'min': 77.283916015625}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1322366.0, 'mean': 1210689.8055555555, 'min': 941267.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 134.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 98.36693455825618, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 98.36693455825618, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.0045580451871141976, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
- Temporal highlight summary: `{'frame_count': 36, 'pair_count': 35, 'sample_width': 320, 'highlight_threshold': 220, 'mean_delta': {'min': 1.3228125, 'mean': 3.291839285714286, 'max': 11.024826388888888}, 'peak_delta': {'min': 79, 'mean': 111.68571428571428, 'max': 154}, 'highlight_change_ratio': {'min': 0.0, 'mean': 0.0001195436507936508, 'max': 0.0005902777777777778}, 'highlight_ratio': {'min': 0.0, 'mean': 7.040895061728394e-05, 'max': 0.0004861111111111111}}`
- Temporal highlight gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_pair_count', 'value': 35.0, 'threshold': 24.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_delta', 'value': 3.291839285714286, 'threshold': 0.25, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_delta', 'value': 11.024826388888888, 'threshold': 16.0, 'operator': '<=', 'passed': True}, {'metric': 'max_peak_delta', 'value': 154.0, 'threshold': 190.0, 'operator': '<=', 'passed': True}, {'metric': 'max_highlight_change_ratio', 'value': 0.0005902777777777778, 'threshold': 0.007, 'operator': '<=', 'passed': True}]}`
...
- Ripple readability summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.3, 0.98, 0.88], 'edge_amplify': 3.5, 'edge_threshold': 18, 'highlight_threshold': 220, 'summary': {'edge_mean': {'min': 19.28515850256378, 'mean': 35.555643926406184, 'max': 48.00599060206038}, 'edge_nonzero_ratio': {'min': 0.26259682371460186, 'mean': 0.3715885225909013, 'max': 0.4462345900285211}, 'highlight_ratio': {'min': 0.0, 'mean': 0.00019092000062341226, 'max': 0.00042859591976684384}, 'mean_luminance': {'min': 71.00306446082634, 'mean': 91.85068960109409, 'max': 114.3119671773452}}}`
- Ripple readability gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_edge_mean', 'value': 35.555643926406184, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_edge_nonzero_ratio', 'value': 0.3715885225909013, 'threshold': 0.025, 'operator': '>=', 'passed': True}, {'metric': 'max_highlight_ratio', 'value': 0.00042859591976684384, 'threshold': 0.01, 'operator': '<=', 'passed': True}]}`
...
| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 55.80s |
| `validate_render_cache` | `0` | 71.84s |
| `reconstruct_water` | `0` | 65.24s |
| `convert_render_cache` | `0` | 130.02s |
| `render_blender` | `0` | 240.87s |
| `assemble_gif` | `0` | 2.89s |

## S97 to S98 Delta

- Render preset remains `dam_break_secondary_volume_depth_tuned`; this step adds review infrastructure rather than changing material tuning.
- Added `secondary_depth_comparison_sheet.png` and `secondary_depth_comparison_manifest.json`.
- Secondary depth comparison source count is `2`, comparing S97 against S98.
- The comparison labels now use shot directory names so identical render presets remain distinguishable.
- Visual QA, temporal highlight QA, secondary framing QA, focus review QA, ripple readability QA, and secondary depth review QA all pass.
