# S502 Mitsuba Low Frequency Backend Adapter Validation

Generated UTC: `2026-06-20T18:56:41.761838+00:00`
Validation JSON: `build/shots/s502_mitsuba_low_frequency_backend_adapter/backend_adapter_validation.json`
Status: `passed`
Manifest: `build/shots/s502_mitsuba_low_frequency_backend_adapter/backend_adapter_manifest.json`
...
| `source:job` | `ok` | build/shots/s499_mitsuba_low_frequency_renderer_job_manifest/renderer_job_manifest.json |
...
| `shader:glsl` | `ok` | build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/shaders/low_frequency_parity_post_tonemap.glsl |
| `shader:hlsl` | `ok` | build/shots/s498_mitsuba_low_frequency_renderer_acceptance_package/shaders/low_frequency_parity_post_tonemap.hlsl |
...
| `command_list` | `ok` | build/shots/s502_mitsuba_low_frequency_backend_adapter/backend_commands.txt |
...
| `frame:0:reference` | `ok` | build/shots/s497_mitsuba_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0000.png |
...
| `frame:1:reference` | `ok` | build/shots/s497_mitsuba_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0001.png |
...
| `frame:2:reference` | `ok` | build/shots/s497_mitsuba_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0002.png |
...
| `frame:3:reference` | `ok` | build/shots/s497_mitsuba_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0003.png |
...
| `frame:4:reference` | `ok` | build/shots/s497_mitsuba_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0004.png |
...
| `frame:5:reference` | `ok` | build/shots/s497_mitsuba_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0005.png |
...
| `frame:6:reference` | `ok` | build/shots/s497_mitsuba_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0006.png |
...
| `frame:7:reference` | `ok` | build/shots/s497_mitsuba_low_frequency_renderer_runtime_preview/renderer_runtime/frame_0007.png |
