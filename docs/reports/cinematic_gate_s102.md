...
- Status: `ok`
- Shot preset: `dam_break_water_volume_scattering`
- Render preset: `dam_break_water_volume_scattering`
...
- manifest: `build/shots/s102_water_volume_scattering/cache/manifest.json`
- sequence: `build/shots/s102_water_volume_scattering/converted/sequence.json`
- water_reconstruction: `build/shots/s102_water_volume_scattering/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s102_water_volume_scattering/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s102_water_volume_scattering/blender/frames`
- gif: `build/shots/s102_water_volume_scattering/shot.gif`
- contact_sheet: `build/shots/s102_water_volume_scattering/review/contact_sheet.png`
- review_manifest: `build/shots/s102_water_volume_scattering/review/review_manifest.json`
- comparison_sheet: `build/shots/s102_water_volume_scattering/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s102_water_volume_scattering/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s102_water_volume_scattering/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s102_water_volume_scattering/review/temporal_diff_manifest.json`
- focus_sheet: `build/shots/s102_water_volume_scattering/review/focus_sheet.png`
- focus_review_manifest: `build/shots/s102_water_volume_scattering/review/focus_review_manifest.json`
- focus_comparison_sheet: `build/shots/s102_water_volume_scattering/review/focus_comparison_sheet.png`
- focus_comparison_manifest: `build/shots/s102_water_volume_scattering/review/focus_comparison_manifest.json`
- secondary_depth_sheet: `build/shots/s102_water_volume_scattering/review/secondary_depth_sheet.png`
- secondary_depth_manifest: `build/shots/s102_water_volume_scattering/review/secondary_depth_manifest.json`
- secondary_depth_comparison_sheet: `build/shots/s102_water_volume_scattering/review/secondary_depth_comparison_sheet.png`
- secondary_depth_comparison_manifest: `build/shots/s102_water_volume_scattering/review/secondary_depth_comparison_manifest.json`
- ripple_readability_sheet: `build/shots/s102_water_volume_scattering/review/ripple_readability_sheet.png`
- ripple_readability_manifest: `build/shots/s102_water_volume_scattering/review/ripple_readability_manifest.json`
- ripple_readability_comparison_sheet: `build/shots/s102_water_volume_scattering/review/ripple_readability_comparison_sheet.png`
- ripple_readability_comparison_manifest: `build/shots/s102_water_volume_scattering/review/ripple_readability_comparison_manifest.json`
- review_dir: `build/shots/s102_water_volume_scattering/review`
...
- Focus review summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.42, 0.98, 0.95], 'bright_threshold': 220, 'nonblank_threshold': 8, 'summary': {'mean_luminance': {'min': 75.72363226290567, 'mean': 92.46960057216432, 'max': 114.84803537015877}, 'contrast': {'min': 72.0, 'mean': 146.75, 'max': 196.0}, 'bright_ratio': {'min': 0.0, 'mean': 0.00011538149973566179, 'max': 0.0004689871582789024}, 'nonblank_ratio': {'min': 1.0, 'mean': 1.0, 'max': 1.0}}}`
- Focus review gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.95, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 72.0, 'threshold': 60.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 92.46960057216432, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 92.46960057216432, 'threshold': 125.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.00011538149973566179, 'threshold': 0.0, 'operator': '>=', 'passed': True}]}`
...
- Ripple readability summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.3, 0.98, 0.88], 'edge_amplify': 3.5, 'edge_threshold': 18, 'highlight_threshold': 220, 'summary': {'edge_mean': {'min': 15.993534046101336, 'mean': 29.766442498012875, 'max': 40.69009203123295}, 'edge_nonzero_ratio': {'min': 0.23462509546000032, 'mean': 0.3516919310973614, 'max': 0.4398407181709085}, 'highlight_ratio': {'min': 0.0, 'mean': 0.00015999290868569114, 'max': 0.0003779436747034895}, 'mean_luminance': {'min': 73.27956337764755, 'mean': 94.0189220228169, 'max': 117.7615175412621}}}`
- Ripple readability gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_edge_mean', 'value': 29.766442498012875, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_edge_nonzero_ratio', 'value': 0.3516919310973614, 'threshold': 0.025, 'operator': '>=', 'passed': True}, {'metric': 'max_highlight_ratio', 'value': 0.0003779436747034895, 'threshold': 0.01, 'operator': '<=', 'passed': True}]}`
...
| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 78.36s |
| `validate_render_cache` | `0` | 65.00s |
| `reconstruct_water` | `0` | 42.01s |
| `convert_render_cache` | `0` | 79.59s |
| `render_blender` | `0` | 208.26s |
| `assemble_gif` | `0` | 3.96s |
