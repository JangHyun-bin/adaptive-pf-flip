# S370 Mitsuba Material Key Light KL5 Smoke Export

Generated UTC: `2026-06-20T04:34:48.839456+00:00`
Export JSON: `build/shots/s370_mitsuba_material_keylight_kl5_smoke/mitsuba_export.json`
Status: `ready`
...
- Command list: `build/shots/s370_mitsuba_material_keylight_kl5_smoke/mitsuba_render_commands.txt`
...
- Key light radiance: `[0.012, 0.015, 0.02]`
...
| ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 0 | `build/shots/s370_mitsuba_material_keylight_kl5_smoke/scenes/frame_0000.xml` | 8 | 20000 | 256 | 256 | 0 | 256 | 0 |

## Next

Render this very weak off-camera key-light smoke scene before considering it as a candidate.
