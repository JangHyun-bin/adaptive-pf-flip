...
- manifest: `build/shots/s92_ripple_diagnostic_comparison/cache/manifest.json`
- sequence: `build/shots/s92_ripple_diagnostic_comparison/converted/sequence.json`
- water_reconstruction: `build/shots/s92_ripple_diagnostic_comparison/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s92_ripple_diagnostic_comparison/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s92_ripple_diagnostic_comparison/blender/frames`
- gif: `build/shots/s92_ripple_diagnostic_comparison/shot.gif`
- contact_sheet: `build/shots/s92_ripple_diagnostic_comparison/review/contact_sheet.png`
- review_manifest: `build/shots/s92_ripple_diagnostic_comparison/review/review_manifest.json`
- comparison_sheet: `build/shots/s92_ripple_diagnostic_comparison/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s92_ripple_diagnostic_comparison/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s92_ripple_diagnostic_comparison/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s92_ripple_diagnostic_comparison/review/temporal_diff_manifest.json`
- focus_sheet: `build/shots/s92_ripple_diagnostic_comparison/review/focus_sheet.png`
- focus_review_manifest: `build/shots/s92_ripple_diagnostic_comparison/review/focus_review_manifest.json`
- focus_comparison_sheet: `build/shots/s92_ripple_diagnostic_comparison/review/focus_comparison_sheet.png`
- focus_comparison_manifest: `build/shots/s92_ripple_diagnostic_comparison/review/focus_comparison_manifest.json`
- ripple_readability_sheet: `build/shots/s92_ripple_diagnostic_comparison/review/ripple_readability_sheet.png`
- ripple_readability_manifest: `build/shots/s92_ripple_diagnostic_comparison/review/ripple_readability_manifest.json`
- ripple_readability_comparison_sheet: `build/shots/s92_ripple_diagnostic_comparison/review/ripple_readability_comparison_sheet.png`
- ripple_readability_comparison_manifest: `build/shots/s92_ripple_diagnostic_comparison/review/ripple_readability_comparison_manifest.json`
- review_dir: `build/shots/s92_ripple_diagnostic_comparison/review`
...
- Focus review summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.3, 0.98, 0.88], 'bright_threshold': 220, 'nonblank_threshold': 8, 'summary': {'mean_luminance': {'min': 70.9503822296339, 'mean': 92.25567913945733, 'max': 114.72933193585088}, 'contrast': {'min': 78.0, 'mean': 152.625, 'max': 202.0}, 'bright_ratio': {'min': 0.0, 'mean': 0.00037331678693327934, 'max': 0.001011096737995418}, 'nonblank_ratio': {'min': 1.0, 'mean': 1.0, 'max': 1.0}}}`
...
| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 56.85s |
| `validate_render_cache` | `0` | 99.36s |
| `reconstruct_water` | `0` | 61.86s |
| `convert_render_cache` | `0` | 80.00s |
| `render_blender` | `0` | 194.69s |
| `assemble_gif` | `0` | 2.93s |

## S91 to S92 Delta

- The runner now emits `ripple_readability_comparison_sheet` and `ripple_readability_comparison_manifest` when compared review manifests include `ripple_readability_sheet`.
- Ripple readability comparison source count is `2`, comparing S91 against S92.
- The S92 diagnostic comparison manifest uses schema `lsfs_cinematic_ripple_readability_comparison`.
