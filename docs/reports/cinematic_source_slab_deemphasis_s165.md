...
- Status: `ok`
- Shot preset: `dam_break_source_slab_deemphasis`
- Render preset: `dam_break_source_slab_deemphasis`
...
- manifest: `build/shots/s165_source_slab_deemphasis/cache/manifest.json`
- export_stamp: `build/shots/s165_source_slab_deemphasis/cache/export_stamp.json`
- validation_stamp: `build/shots/s165_source_slab_deemphasis/cache/validation_stamp.json`
- sequence: `build/shots/s165_source_slab_deemphasis/converted/sequence.json`
- water_reconstruction: `build/shots/s165_source_slab_deemphasis/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s165_source_slab_deemphasis/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s165_source_slab_deemphasis/blender/frames`
- gif: `build/shots/s165_source_slab_deemphasis/shot.gif`
- gif_stamp: `build/shots/s165_source_slab_deemphasis/gif_stamp.json`
- contact_sheet: `build/shots/s165_source_slab_deemphasis/review/contact_sheet.png`
- review_manifest: `build/shots/s165_source_slab_deemphasis/review/review_manifest.json`
- comparison_sheet: `build/shots/s165_source_slab_deemphasis/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s165_source_slab_deemphasis/review/comparison_manifest.json`
- temporal_diff_sheet: `build/shots/s165_source_slab_deemphasis/review/temporal_diff_sheet.png`
- temporal_diff_manifest: `build/shots/s165_source_slab_deemphasis/review/temporal_diff_manifest.json`
- focus_sheet: `build/shots/s165_source_slab_deemphasis/review/focus_sheet.png`
- focus_review_manifest: `build/shots/s165_source_slab_deemphasis/review/focus_review_manifest.json`
- focus_comparison_sheet: `build/shots/s165_source_slab_deemphasis/review/focus_comparison_sheet.png`
- focus_comparison_manifest: `build/shots/s165_source_slab_deemphasis/review/focus_comparison_manifest.json`
- secondary_depth_sheet: `build/shots/s165_source_slab_deemphasis/review/secondary_depth_sheet.png`
- secondary_depth_manifest: `build/shots/s165_source_slab_deemphasis/review/secondary_depth_manifest.json`
- secondary_depth_comparison_sheet: `build/shots/s165_source_slab_deemphasis/review/secondary_depth_comparison_sheet.png`
- secondary_depth_comparison_manifest: `build/shots/s165_source_slab_deemphasis/review/secondary_depth_comparison_manifest.json`
- ripple_readability_sheet: `build/shots/s165_source_slab_deemphasis/review/ripple_readability_sheet.png`
- ripple_readability_manifest: `build/shots/s165_source_slab_deemphasis/review/ripple_readability_manifest.json`
- ripple_readability_comparison_sheet: `build/shots/s165_source_slab_deemphasis/review/ripple_readability_comparison_sheet.png`
- ripple_readability_comparison_manifest: `build/shots/s165_source_slab_deemphasis/review/ripple_readability_comparison_manifest.json`
- review_dir: `build/shots/s165_source_slab_deemphasis/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.0045768229166666665, 'mean': 0.002005901572145062, 'min': 0.0008224826388888889}, 'contrast': {'max': 195.0, 'mean': 191.94444444444446, 'min': 186.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.000400390625, 'mean': 0.0001233060860339506, 'min': 7.595486111111111e-06}, 'mean_luminance': {'max': 95.25447157118056, 'mean': 89.45182385103202, 'min': 87.30147786458333}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1250126.0, 'mean': 1232572.111111111, 'min': 1199499.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 186.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 89.45182385103202, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 89.45182385103202, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.002005901572145062, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
- Temporal highlight summary: `{'frame_count': 36, 'pair_count': 35, 'sample_width': 320, 'highlight_threshold': 220, 'mean_delta': {'min': 1.9652951388888888, 'mean': 4.128566964285715, 'max': 7.531996527777777}, 'peak_delta': {'min': 46, 'mean': 87.48571428571428, 'max': 138}, 'highlight_change_ratio': {'min': 0.0, 'mean': 7.936507936507936e-06, 'max': 8.680555555555556e-05}, 'highlight_ratio': {'min': 0.0, 'mean': 4.340277777777778e-06, 'max': 5.208333333333334e-05}}`
- Temporal highlight gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_pair_count', 'value': 35.0, 'threshold': 24.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_delta', 'value': 4.128566964285715, 'threshold': 0.25, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_delta', 'value': 7.531996527777777, 'threshold': 16.0, 'operator': '<=', 'passed': True}, {'metric': 'max_peak_delta', 'value': 138.0, 'threshold': 190.0, 'operator': '<=', 'passed': True}, {'metric': 'max_highlight_change_ratio', 'value': 8.680555555555556e-05, 'threshold': 0.007, 'operator': '<=', 'passed': True}]}`
- Water depth strength: `0.62`
- Water rim strength: `0.58`
- Water surface detail: `{'depth': 6, 'enabled': True, 'scale': 2.8, 'strength': 0.07}`
- Water surface glint pass: `{'alpha_scale': 0.38, 'count': 190, 'drift_per_frame': 0.12, 'emission_scale': 0.86, 'enabled': True, 'flow_dir': [1.0, 0.0, 0.22], 'length': 1.65, 'region_max': [31.4, 8.2, 21.4], 'region_min': [1.0, 3.9, 3.0], 'width': 0.042}`
- Water reflection pass: `{'alpha_scale': 0.42, 'count': 72, 'drift_per_frame': 0.048, 'emission_scale': 0.9, 'enabled': True, 'flow_dir': [1.0, 0.0, 0.14], 'length': 5.6, 'region_max': [31.2, 8.3, 21.2], 'region_min': [1.0, 4.0, 3.4], 'width': 0.13}`
...
- Focus review summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.24, 0.98, 0.98], 'bright_threshold': 220, 'nonblank_threshold': 8, 'summary': {'mean_luminance': {'min': 86.44512042339166, 'mean': 90.07010858272577, 'max': 94.97662423379433}, 'contrast': {'min': 82.0, 'mean': 152.75, 'max': 195.0}, 'bright_ratio': {'min': 0.0, 'mean': 4.812657748226192e-05, 'max': 0.00011458708924348076}, 'nonblank_ratio': {'min': 1.0, 'mean': 1.0, 'max': 1.0}}}`
- Focus review gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.95, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 82.0, 'threshold': 54.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 90.07010858272577, 'threshold': 62.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 90.07010858272577, 'threshold': 132.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 4.812657748226192e-05, 'threshold': 0.0, 'operator': '>=', 'passed': True}]}`
...
- Ripple readability summary: `{'enabled': True, 'frame_count': 8, 'crop': [0.02, 0.24, 0.98, 0.98], 'edge_amplify': 3.5, 'edge_threshold': 18, 'highlight_threshold': 220, 'summary': {'edge_mean': {'min': 28.323975896987733, 'mean': 34.58111849221724, 'max': 37.123940451381465}, 'edge_nonzero_ratio': {'min': 0.3675785761866639, 'mean': 0.3793080925985907, 'max': 0.3876634011892612}, 'highlight_ratio': {'min': 0.0, 'mean': 4.812657748226192e-05, 'max': 0.00011458708924348076}, 'mean_luminance': {'min': 86.44512042339166, 'mean': 90.07010858272577, 'max': 94.97662423379433}}}`
- Ripple readability gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_frame_count', 'value': 8.0, 'threshold': 8.0, 'operator': '>=', 'passed': True}, {'metric': 'min_edge_mean', 'value': 34.58111849221724, 'threshold': 6.0, 'operator': '>=', 'passed': True}, {'metric': 'min_edge_nonzero_ratio', 'value': 0.3793080925985907, 'threshold': 0.02, 'operator': '>=', 'passed': True}, {'metric': 'max_highlight_ratio', 'value': 0.00011458708924348076, 'threshold': 0.012, 'operator': '<=', 'passed': True}]}`
...
| `validate_render_cache` | `0` | 3.05s |
| `reconstruct_water` | `0` | 3.19s |
| `convert_render_cache` | `0` | 3.28s |
| `render_blender` | `0` | 620.29s |
| `assemble_gif` | `0` | 2.84s |
