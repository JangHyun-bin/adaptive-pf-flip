...
- manifest: `build/shots/s68_secondary_mist_quality/cache/manifest.json`
- sequence: `build/shots/s68_secondary_mist_quality/converted/sequence.json`
- water_reconstruction: `build/shots/s68_secondary_mist_quality/water_mesh/water_reconstruction.json`
- render_summary: `build/shots/s68_secondary_mist_quality/blender/bridge_summary.json`
- render_frame_dir: `build/shots/s68_secondary_mist_quality/blender/frames`
- gif: `build/shots/s68_secondary_mist_quality/shot.gif`
- contact_sheet: `build/shots/s68_secondary_mist_quality/review/contact_sheet.png`
- review_manifest: `build/shots/s68_secondary_mist_quality/review/review_manifest.json`
- comparison_sheet: `build/shots/s68_secondary_mist_quality/review/comparison_sheet.png`
- comparison_manifest: `build/shots/s68_secondary_mist_quality/review/comparison_manifest.json`
- review_dir: `build/shots/s68_secondary_mist_quality/review`
...
- Visual QA summary: `{'bright_ratio': {'max': 0.017444661458333333, 'mean': 0.007281569492669754, 'min': 1.0850694444444444e-06}, 'contrast': {'max': 203.0, 'mean': 185.16666666666666, 'min': 90.0}, 'dark_ratio': {'max': 0.0, 'mean': 0.0, 'min': 0.0}, 'frame_count': 36, 'highlight_ratio': {'max': 0.0018055555555555555, 'mean': 0.0006251808449074074, 'min': 0.0}, 'mean_luminance': {'max': 113.70670030381945, 'mean': 95.57925244743441, 'min': 75.35672526041667}, 'nonblank_ratio': {'max': 1.0, 'mean': 1.0, 'min': 1.0}, 'png_bytes': {'max': 1315138.0, 'mean': 1173205.3333333333, 'min': 856246.0}}`
- Visual QA gate: `{'enabled': True, 'passed': True, 'checks': [{'metric': 'min_nonblank_ratio', 'value': 1.0, 'threshold': 0.9, 'operator': '>=', 'passed': True}, {'metric': 'min_contrast', 'value': 90.0, 'threshold': 80.0, 'operator': '>=', 'passed': True}, {'metric': 'min_mean_luminance', 'value': 95.57925244743441, 'threshold': 70.0, 'operator': '>=', 'passed': True}, {'metric': 'max_mean_luminance', 'value': 95.57925244743441, 'threshold': 120.0, 'operator': '<=', 'passed': True}, {'metric': 'min_mean_bright_ratio', 'value': 0.007281569492669754, 'threshold': 0.0005, 'operator': '>=', 'passed': True}]}`
...
- Secondary soft pass: `{'alpha_scale': 0.24, 'channels': {'foam': 2.0, 'spray': 2.35}, 'emission_scale': 0.75, 'enabled': True, 'geometry': 'billboard_disks', 'max_radius': 1.05}`
...
- S67 batched soft spray/foam halos as sphere clouds and reduced render time to `105.16s`.
- S68 switches the soft pass to `geometry=billboard_disks`, with alpha scale `0.24` and emission scale `0.75`.
- Visual QA still passed, and mean bright ratio increased to `0.007281569492669754`.
- Blender render time stayed comparable at `100.31s`, but visible circular billboard edges remain a limitation.

## Stage Timings

| Stage | Exit | Elapsed |
| --- | ---: | ---: |
| `export_render_cache` | `0` | 77.09s |
| `validate_render_cache` | `0` | 83.81s |
| `reconstruct_water` | `0` | 63.88s |
| `convert_render_cache` | `0` | 95.12s |
| `render_blender` | `0` | 100.31s |
| `assemble_gif` | `0` | 2.68s |
